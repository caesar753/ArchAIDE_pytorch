...
#intfeat = 20
intfeat1 = input("Please enter a first intermediate feature value (integer):\n")
intfeat1 = int(intfeat1)

intfeat2 = input("Please enter a second intermediate feature value (integer):\n")
intfeat2 = int(intfeat2)
...
model.fc = nn.Sequential(
    nn.Dropout(dropout),
    nn.Linear(model.fc.in_features, intfeat1),
    nn.ReLU(),
    nn.Dropout(dropout),
    nn.Linear(intfeat1, intfeat2),
    nn.Linear(intfeat2, number_of_classes)
)
...
print(f'Summary:\n \
        ...
        batch:{batch_size},\n \
        learning rate: {lr},\n \
        Intermediate features: first layer: {intfeat1}, second layer:{intfeat2}\n \
        Dropout:{dropout},\n \
        optimizer: {optimizer} \n')
...
print(f'Summary: Neural Network:{model_down},\n \
    epochs:{num_epochs},batch:{batch_size}, learning rate: {lr}, \
    Intermediate features: first layer:{intfeat1}, second layer:{intfeat2},\
    Dropout:{dropout},\n \
    optimizer: {optimizer} \n \
...
fig.suptitle(f'Model:{model_down}, Intermediate features: {intfeat1} -> {intfeat2}, Dropout:{dropout} Epochs: {num_epochs}, optimizer: {optim_choose} with momentum:{momentum} and gamma: {gamma}, \n Loss function:{loss}, learning rate:{lr}')
